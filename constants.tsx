...
// Logo Aplikasi (Default untuk UI)
export const DEFAULT_LOGO = LOGO_DJKI_URL;

// Logo Template Default (Jika belum diatur di Settings)
...
export const PENDIDIKAN_LIST = ["SD-SD/SEDERAJAT", "SLTA", "SLTA-IPA", "SLTA-SLTA/SMA SEDERAJAT", "DIII", "DIV", "S1", "S2", "S3"];

...
import { PolaDistribusiCurve } from './PolaDistribusiCurve';
...
export const EvaluasiKinerjaPages56: React.FC<PageProps> = ({ data, pSubjek, pPenilai }) => {
  ...
  return (
    <>
      {/* HALAMAN 5: EVALUASI KINERJA PEGAWAI (HASIL KERJA & DISTRIBUSI) */}
      <div className="skp-page-item bg-white p-[1.2cm] text-black font-sans text-[7.5pt] leading-normal flex flex-col justify-between mb-8 shadow-sm" style={{ width: '210mm', minHeight: '297mm' }}>
        <div>
          {/* Header Title */}
          ...
          {/* Capaian Kinerja Organisasi & Pola Distribusi */}
          <div className="border border-black mb-3">
            <table className="w-full border-collapse text-[8pt]">
              <tbody>
                <tr className="border-b border-black">
                  <td className="w-48 p-1.5 font-bold bg-[#bdd7ee] border-r border-black uppercase">
                ...
                <tr>
                  <td className="p-1.5 font-bold bg-[#bdd7ee] border-r border-black align-middle uppercase">
                    POLA DISTRIBUSI:
                  </td>
                  <td className="p-2 bg-white">
                    <PolaDistribusiCurve capaianOrganisasi={data.capaianOrganisasi || 'ISTIMEWA'} />
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          {/* Tabel HASIL KERJA Evaluasi */}
          <div className="border border-black">
            <div className="bg-[#bdd7ee] border-b border-black px-2 py-1 font-bold text-[8pt] uppercase text-left">
              HASIL KERJA
            </div>
            <table className="w-full border-collapse text-[6.8pt] leading-tight">
              <thead>
                <tr className="bg-[#bdd7ee] border-b border-black font-bold text-center">
                  <th className="w-5 p-1 border-r border-black">NO<br/>(1)</th>
                  <th className="w-36 p-1 border-r border-black">RENCANA HASIL KERJA PIMPINAN YANG DIINTERVENSI<br/>(2)</th>
                  <th className="w-36 p-1 border-r border-black">RENCANA HASIL KERJA<br/>(3)</th>
                  <th className="w-12 p-1 border-r border-black">ASPEK<br/>(4)</th>
                  <th className="p-1 border-r border-black">INDIKATOR KINERJA INDIVIDU<br/>(5)</th>
                  <th className="w-12 p-1 border-r border-black">TARGET<br/>(6)</th>
                  <th className="w-14 p-1 border-r border-black">REALISASI BERDASARKAN BUKTI DUKUNG<br/>(7)</th>
                  <th className="w-36 p-1 border-black">UMPAN BALIK BERKELANJUTAN BERDASARKAN BUKTI DUKUNG<br/>(8)</th>
                </tr>
              </thead>
              <tbody>
                {/* A. KINERJA UTAMA */}
                <tr className="bg-gray-50 font-bold border-b border-black">
                  <td className="p-1 border-r border-black" colSpan={8}>A. KINERJA UTAMA</td>
                </tr>
                {rhkUtama.length > 0 ? (
                  rhkUtama.map((row, idx) => (
                    <tr key={idx} className="border-b border-black">
                      ...
                      <td className="p-1 border-r border-black text-center align-top">{row.target}</td>
                      <td className="p-1 border-r border-black text-center align-top font-semibold">{row.realisasi || row.target}</td>
                      <td className="p-1 border-black align-top uppercase">{row.umpanBalik || 'DAPAT DIPERTAHANKAN'}</td>
                    </tr>
                  ))
                ) : (
                  <tr className="border-b border-black">
                    ...
                    <td className="p-1 border-r border-black text-center">-</td>
                    <td className="p-1 border-r border-black text-center">-</td>
                    <td className="p-1 border-black">-</td>
                  </tr>
                )}
                ...
                {rhkTambahan.length > 0 && (
                  <>
                    <tr className="bg-gray-50 font-bold border-b border-black">
                      <td className="p-1 border-r border-black" colSpan={8}>B. KINERJA TAMBAHAN</td>
                    </tr>
      ...
      {/* HALAMAN 6: EVALUASI KINERJA PEGAWAI (PERILAKU, RATINGS & TTD) */}
      <div className="skp-page-item bg-white p-[1.2cm] text-black font-sans text-[7.5pt] leading-normal flex flex-col justify-between mb-8 shadow-sm" style={{ width: '210mm', minHeight: '297mm' }}>
        <div>
          {/* Rating Hasil Kerja */}
          <div className="border border-black mb-2">
            <table className="w-full border-collapse">
              <tbody>
                <tr>
                  <td className="w-48 p-1.5 font-bold bg-[#bdd7ee] border-r border-black uppercase text-[8pt]">
                    RATING HASIL KERJA*
                  </td>
                  <td className="p-1.5 font-bold uppercase text-[8pt]">
          ...
          {/* Tabel Perilaku Kerja dengan Umpan Balik */}
          <div className="border border-black mb-3">
            <table className="w-full border-collapse text-[7.2pt]">
              <thead>
                <tr className="bg-[#bdd7ee] border-b border-black font-bold text-center">
                  <th className="p-1.5 border-r border-black text-left w-2/5">CORE VALUES BERAKHLAK</th>
                  <th className="p-1.5 border-r border-black text-left w-1/4">EKSPEKTASI KHUSUS PIMPINAN</th>
                  <th className="p-1.5 border-black text-left">UMPAN BALIK BERKELANJUTAN BERDASARKAN BUKTI DUKUNG</th>
                </tr>
              </thead>
              <tbody>
                {perilakuKerja.map((item, idx) => (
                  <tr key={idx} className="border-b border-black last:border-b-0">
                    ...
                    <td className="p-1.5 border-r border-black align-top font-medium">
                      {item.ekspektasi || 'Untuk Dapat Dipertahankan'}
                    </td>
                    <td className="p-1.5 align-top">
                      <div className="font-medium text-black">
                        {item.umpanBalik || 'Dapat dipertahankan dan terus ditingkatkan'}
                      </div>
                    </td>
                  </tr>
                ))}
          ...
          <div className="border border-black">
            <table className="w-full border-collapse text-[8pt]">
              <tbody>
                <tr className="border-b border-black">
                  <td className="w-56 p-1.5 font-bold bg-[#bdd7ee] border-r border-black uppercase">
                ...
                <tr>
                  <td className="p-1.5 font-bold bg-[#bdd7ee] border-r border-black uppercase">
        ...
        {/* Tanda Tangan */}
        <div className="grid grid-cols-2 text-[8.5pt] pt-6">
          <div className="flex flex-col items-center text-center">
            <p className="mb-16">Pegawai yang Dinilai</p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mb-16">Pejabat Penilai Kinerja</p>

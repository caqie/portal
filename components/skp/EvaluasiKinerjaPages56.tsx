...
export const EvaluasiKinerjaPages56: React.FC<PageProps> = ({ data, pSubjek, pPenilai }) => {
  ...
  return (
    <>
      {/* HALAMAN 5: EVALUASI KINERJA PEGAWAI (HASIL KERJA & DISTRIBUSI) - LANDSCAPE */}
      <div 
        ...
        <div>
          ...
          <div className="text-center mb-3">
            ...
            <p className="text-[8pt] font-bold uppercase mt-1">
              PERIODE : {data.periodeLabel || 'AKHIR'} | PERIODE PENILAIAN : {periodeText}
            </p>
          </div>
              ...
              <tbody>
                ...
                {rhkUtama.length > 0 ? (
                  ...
                  <tr className="border-b border-black">
                    ...
                    <td className="p-1.5 border-r border-black text-center">-</td>
                    <td className="p-1.5 border-r border-black text-center">-</td>
                    <td className="p-1.5 border-black">-</td>
                  </tr>
                )}
                ...
                {rhkTambahan.length > 0 && (
                  <>
                    <tr className="bg-gray-50 font-bold border-b border-black">
                      <td className="p-1.5 border-r border-black align-middle" colSpan={8}>B. KINERJA TAMBAHAN</td>
                    </tr>
      ...
      {/* HALAMAN 6: EVALUASI KINERJA PEGAWAI (PERILAKU, RATINGS & TTD) - LANDSCAPE */}
      <div 
        ...
        <div>
          ...
          <div className="border border-black mb-2">
            <table className="w-full border-collapse">
              <tbody>
                <tr>
                  <td className="w-56 p-1.5 font-bold bg-[#bdd7ee] border-r border-black uppercase text-[8pt] align-middle">
                    RATING HASIL KERJA*
                  </td>
          ...
          <div className="border border-black mb-2">
            <table className="w-full border-collapse text-[7.2pt]">
              <thead>
                <tr className="bg-[#bdd7ee] border-b border-black font-bold text-center">
                  <th className="p-1.5 border-r border-black text-left w-1/3 align-middle">CORE VALUES BERAKHLAK</th>

...
export const PresensiNavigationHeader: React.FC<PresensiNavigationHeaderProps> = ({
  ...
  const { user, isSuperadmin, canEdit, isAdminUangMakan, isOnlyAdminUangMakan } = useAuth();
  ...
  const hasAdminAccess = !isOnlyAdminUangMakan && (isSuperadmin || canEdit || user?.role === 'Superadmin' || user?.role?.includes('Admin Perencanaan'));
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <button
            ...
            title={isOnlyAdminUangMakan ? "Kembali ke Data Diri / User Page" : "Kembali ke Dashboard"}
          >
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black text-emerald-700 uppercase tracking-widest">
                {isOnlyAdminUangMakan ? "Modul Khusus Admin Uang Makan" : "Presensi & Kehadiran Terpadu"}
              </span>
            </div>

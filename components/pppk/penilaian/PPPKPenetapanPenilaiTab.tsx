...
export const PPPKPenetapanPenilaiTab: React.FC<PPPKPenetapanPenilaiTabProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* SECTION 2: ADMIN VERIFICATION QUEUE */}
      {(activeRole === 'ADMIN') && (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-sm font-black text-slate-800">
                Antrean Verifikasi Usulan Pejabat Penilai (Kewenangan Admin SDM)
              </h4>
            </div>
            <span className="text-xs text-slate-500 font-bold">Admin dapat Menyetujui atau Menolak usulan</span>
          </div>
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-slate-100 text-slate-700 uppercase font-black text-[11px] border-b border-slate-200">
                  ...
                  <th className="py-3 px-4">Pejabat Penilai yang Diusulkan</th>
                  <th className="py-3 px-4">Jenis Jabatan</th>
              ...
              <tbody className="divide-y divide-slate-200">
                {periodAssignments.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="py-6 text-center text-slate-400">Tidak ada usulan penugasan.</td>
                  </tr>
                ) : (
                  periodAssignments.map(a => (
                        ...
                        {a.status === 'MENUNGGU_VERIFIKASI' ? (
                          <div className="flex items-center justify-center gap-2">
                            <button
                              ...
                              className="px-3 py-1 bg-emerald-600 text-white rounded-lg font-bold text-xs hover:bg-emerald-700 shadow-sm"
                            >
                              Setujui
                            </button>
                            <button
                              ...
                              className="px-3 py-1 bg-rose-600 text-white rounded-lg font-bold text-xs hover:bg-rose-700 shadow-sm"
                            >
                              Tolak
                            </button>
                          </div>
                        ) : (
                          <span className="text-[11px] text-slate-400 font-semibold">Telah Diverifikasi</span>
                        )}
                      </td>
                    </tr>
                  ))

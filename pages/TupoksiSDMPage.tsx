...
const ALL_SDM_MODULES: SDMModuleItem[] = [
  ...
  { id: 'evaluasi-pppk', subTim: 'KARIER', subTimLabel: 'Sub Tim 3: Karier', icon: 'bi-file-earmark-check-fill', label: 'Evaluasi Kinerja PPPK', description: 'Evaluasi Kinerja PPPK Semesteran & Tahunan (SKP 60%, 360° 25%, Presensi 15%)', color: 'indigo', route: '/evaluasi-pppk', badge: 'Baru' },
